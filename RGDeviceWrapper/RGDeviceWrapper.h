...
#define FULL_VTX_SLOT (VTXFLAG_POSITION | VTXFLAG_TEXCOORD01 | VTXFLAG_TEXCOORD23 | VTXFLAG_TEXCOORD45 | VTXFLAG_TEXCOORD67 | VTXFLAG_NORMAL | VTXFLAG_TANGENT | VTXFLAG_BINORMAL | VTXFLAG_BONE | VTXFLAG_WEIGHT | VTXFLAG_COLOR)
#define GENERAL_VTX_FLAG (VTXFLAG_POSITION | VTXFLAG_TEXCOORD01 | VTXFLAG_NORMAL | VTXFLAG_TANGENT | VTXFLAG_BINORMAL | VTXFLAG_USE_WORLD_MAT | VTXFLAG_USE_NORMAL_TEXTURE)
